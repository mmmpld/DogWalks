...
<script type="text/javascript" charset="utf-8">
  var Lat
  var Lng
  var Name = '{$Fields.dataFieldByName("Title").value}' || 'New Walk';
  var Address
  var newWalkMarker
...
<form $FormAttributes class="walkForm">
  ...
  <fieldset id="SuggestForm_Description">
    ...
    <div id="Walk-Name" class="field text">
      <label class="left" for="{$FormName}_Title">Walk Name <span class="requiredText">(Required)</span></label>
      <strong class="requiredText">$Fields.dataFieldByName(Title).Message</strong>
      <div class="middleColumn">
        $Fields.dataFieldByName('Title')
      </div>
    </div>
    <div id="Walk-Description" class="field textarea">
      <label class="left" for="{$FormName}_Content">Walk Description</label>
      <span>Tell us about the walk</span>
      <div class="middleColumn">
        <textarea name="Content" class="textarea" id="WalkSuggestForm_SuggestForm_Content" rows="5" cols="20">$GetPlainContent</textarea>
      </div>
    </div>
    ...
    <div class="field text">
      <div class="middleColumn">
        <table class="layoutTable">
          <tbody>
            <tr>
              <td><label class="left" for="{$FormName}_Playground">Playground</label>$Fields.dataFieldByName('Playground')</td>
              <td>&nbsp;</td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="layoutTable">
          <tbody>
            <tr>
              ...
              <td class="CostDescriptionTD"><label class="left" for="{$FormName}_Cost-Description">Cost Explanation</label>$Fields.dataFieldByName('CostDescription')</td>
            </tr>
          </tbody>
        </table>
      </div>
